...
console.log("Data is " + data);
    ...
    return {
        ...
        payment: {
            ...
            execute: function(payment_id, data, http_options, cb) {
                executeHttp('https', 'POST', '/v1/payments/payment/' + payment_id + '/execute?PayerID=TWLK53YN7GDM6', (typeof data != 'string') ? JSON.stringify(data) : data, http_options, cb);
            },
        },
        sale: {
            refund: function(data, http_options, cb) {
                executeHttp('https', 'POST', '/v1/payments/sale/' + data.id + '/refund', (typeof data != 'string') ? JSON.stringify(data) : data , http_options, cb);
            },
